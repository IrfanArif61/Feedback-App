...
function UserDashboard() {
  ...
  const fetchAcceptMessages = useCallback(async () => {
    ...
    try {
      ...
      console.log("Fetched acceptMessages:", response.data.isAcceptingMessage); // Debug log
  ...
  useEffect(() => {
    ...
    console.log("Session user detected:", session.user); // Debug log
    fetchAcceptMessages();
    fetchMessages();
  ...
  const handleSwitchChange = async () => {
    try {
      ...
      console.log("Switch changed:", !acceptMessages); // Debug log
